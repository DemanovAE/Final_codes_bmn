...
void Get_GraphiCuts_cuts(){	
	...
	TFile *file_inFile 		= new TFile("../qa_root/qa_run8_vf_24.04_final.root","READ");
	TFile *file_outFile = new TFile(Form("./%s/OUT_24.04_GraphCuts.root",path.c_str()),"RECREATE");	
	...
	DrawObjectParH2.push_back({"h2_nTracks_gemDigits","cut4_",0,4,2.,{0,500},{0,15000}});
