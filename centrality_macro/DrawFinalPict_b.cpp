...
void DrawFinalPict_b(){
    ...
    std::map<string,string> file_path_name = {
        {"MC",             "/home/aleksandr/BM@N/centrality_result/glauber_qa_2_raw/glauber_qa_2_raw_Final.root"},
        {"Reco",            "/home/aleksandr/BM@N/centrality_result/glauber_qa_2_raw/glauber_qa_2_raw_Final.root"},
    ...
    _textInfo.DrawLatex(AxisXmin+0.1*(AxisXmax - AxisXmin), 0.85*H_y , 
        Form("#font[42]{ #scale[1.0]{DCM-QGSM-SMM + GEANT4, Xe+Cs 3.8AGeV}}"));
