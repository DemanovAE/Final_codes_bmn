...
void convertBmn_run8_3gev(string inReco="reco.root", string inDigi="digi.root", string inBC1hitInfo="hitInfo.root", std::string fileOut = "out.tree.root")
{
  ...
  auto dd=d
    // pileup
    //.Define("centralHitIndex",CentralHitIndexBC1S,{"bmndata.BmnBC1hitInfo."})
    //.Filter("centralHitIndex>=0")
    /*
    .Define("k1central",  BC1hitClasses,{"bmndata.BmnBC1hitInfo.","centralHitIndex"})
    .Define("k0closest",  ClosestBC1hitsDt_k0, {"bmndata.BmnBC1hitInfo."})
    .Define("kV0closest", ClosestBC1hitsDt_kV0,{"bmndata.BmnBC1hitInfo."})
    .Define("k1closest",  ClosestBC1hitsDt_k1, {"bmndata.BmnBC1hitInfo."})
    .Define("kV1closest", ClosestBC1hitsDt_kV1,{"bmndata.BmnBC1hitInfo."})
    .Define("k0cut", "k0closest.at(0)<-40 && k0closest.at(1)>180")
    .Define("kV0cut", "kV0closest.at(0)<-40 && kV0closest.at(1)>60")
    .Define("k1cut", "k1closest.at(0)<-320 && k1closest.at(1)>560")
    .Define("kV1cut", "kV1closest.at(0)<-1500 && kV1closest.at(1)>560")
    ...
    */
    ...
    .Define("trBetaTof701","BmnGlobalTrack.fBeta701")
    
    .Define("trBetaTof701_2",trBetaTof701_,{"BmnGlobalTrack","BmnTof701Hit"})
    .Define("trBetaTof701_mod",ModHitTof701,{"BmnGlobalTrack","BmnTof701Hit"})
    ...
    .Define("trM2Tof701",trM2,{"trMom","trBetaTof701"})
    .Define("trM2Tof701_2",trM2,{"trMom","trBetaTof701_2"})
    //.Define("trM2Tof701_2",trM2_tof701,{"trMom","trBetaTof701","BmnTof701Hit"})
    ...
    .Define("tof701hitResCalc",tofRes,{"BmnGlobalTrack","BmnTof701Hit"})
