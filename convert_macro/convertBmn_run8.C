...
void convertBmn_run8(string inReco="reco.root", string inDigi="digi.root", string inBC1hitInfo="hitInfo.root", std::string fileOut = "out.tree.root")
{
  ...
  auto dd=d
    ...
    .Define("MpdvtxX","MpdVertex.fX")
    .Define("MpdvtxY","MpdVertex.fY")
    .Define("MpdvtxZ","MpdVertex.fZ")
    .Define("MpdvtxNtracks","MpdVertex.fNTracks")
    .Define("MpdvtxChi2","MpdVertex.fChi2")
    .Define("MpdvtxNdf","MpdVertex.fNDF")
